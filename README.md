...
This repository provides the source codes for our paper [State-Covering Trajectory Stitching for Diffusion Planners](http://arxiv.org/abs/2506.00895) in NeurIPS 2025.
...
1.  Clone the [OGBench](https://github.com/seohongpark/ogbench) repository:
    ```bash
